...
// Exibe as iniciais do usuário logado e o botão de logout em todas as páginas
...
(function() {
    const video = document.getElementById('catarse-video');
    ...
    // Clique no botão de overlay -> play/pause
    ...
    // Sincronizar quando o vídeo muda de estado (inclui controles nativos)
